    ...
    $post_status = $row['post_status']; 
        ...
        ?>
            ...
            <div class="card">
                ...
                <img class="card-img-top" src="/gen/admin/images/<?php echo $post_img; ?>" alt="" width="auto" height="450px">
                ...
                <div class='card-body'>
                    ...
                    <a href="post/<?php echo $post_id ;?>" target="_blank" class='btn btn-primary'>Read more ...</a>
                           <!--  hello .php?p_id= -->
